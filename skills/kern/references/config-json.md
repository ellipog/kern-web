<!-- generated from content/docs/config-json.md - edit the source in kern-web, then run: npm run skill:build -->
...
> **warn** the app owns this file. it rewrites it on every change, and manual edits made while kern is running are overwritten. prefer the ui or the [automation api](./automation-api.md); edit the file only with kern closed.
...
| `automationEnabled` | bool | `true` | serve the loopback [automation api](./automation-api.md) |
...
| `tasks` | array | see [scheduled tasks](./tasks.md) |
