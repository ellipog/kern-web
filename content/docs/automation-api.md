...
slug: automation-api
order: 20
description: the loopback JSON api — every endpoint, auth, and streaming events.
updated: 2026-09-12
---
...
> **warn** the api cannot create or delete users (there are none) and never binds beyond `127.0.0.1`. for phone control over the lan see [web remote](/docs/web-remote) — a separate, token-paired https server.
