...
/*
  §10.2 — Hero. A single viewport: the radar fills the background, the copy
  sits on top. No scroll pinning — the headline still illuminates when the
  sweep passes (radarsweep bridge).
*/
